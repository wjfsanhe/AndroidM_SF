...
public:
    ...
    //baofeng vr renderMode
    enum{
        eRenderLeft2D = 0x00000001,
        eRenderRight2D = 0x00000002,
        eRenderLeft3D = 0x00000004,
        eRenderRight3D = 0x00000008,
        eRenderLeft2DScreenCap = 0x00000010,
        eRenderRight2DScreenCap = 0x00000020,
    };
