...
class TrackerThread;
class HeadTrackInputEventThread;
class VrService ;
...
private:
    ...
    sp<TrackerThread> mTrackerThread;
    sp<VrService> mVrService;
    sp<HeadTrackInputEventThread> mHeadTrackInputEventThread;
