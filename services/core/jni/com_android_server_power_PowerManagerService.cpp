...
static void nativeSetNextBootMode(JNIEnv *env, jobject clazz, jstring mode)
{
    const char *chars = env->GetStringUTFChars(mode, NULL);
    int ret = android_set_next_boot_mode((char *) chars);
    env->ReleaseStringUTFChars(mode, chars);  // In case it fails.
    if (ret) jniThrowIOException(env, errno);
}
...
static JNINativeMethod gPowerManagerServiceMethods[] = {
    ...
    { "nativeSetNextBootMode", "(Ljava/lang/String;)V",
            (void*) nativeSetNextBootMode },
