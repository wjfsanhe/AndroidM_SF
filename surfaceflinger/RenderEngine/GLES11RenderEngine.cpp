...
void GLES11RenderEngine::drawMesh(const Mesh& mesh,int mode)
{
	//do nothing
}


void  GLES11RenderEngine::drawDistortion( )
{
	//do nothing
}


void GLES11RenderEngine::bindTmpFBO( ){
}

void GLES11RenderEngine::bindDisplayFBO( ){
}

void GLES11RenderEngine::drawSkybox(){
	//dosen't do anything  in GLES 1.1
}

void GLES11RenderEngine::setViewMatrix(float* pfViewMatrix)
{
	//dosen't do anything  in GLES 1.1
}
