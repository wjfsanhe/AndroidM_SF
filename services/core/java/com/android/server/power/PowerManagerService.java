...
public final class PowerManagerService extends SystemService
    ...
    private static native void nativeSetNextBootMode(String mode) throws IOException;
    ...
    /**
     * Set next boot mode, passing 'mode' (may be null)
     */
    public void setInternalNextBootMode(String mode)
    {
        synchronized (mLock) {
            try {
                nativeSetNextBootMode(mode);
            } catch (IOException e) {
                Slog.e(TAG, "nativeSetNextBootMode(" + mode + ") error", e);
            }
        }
    }
    ...
    private final class BinderService extends IPowerManager.Stub {
        ...
        * Set next boot mode, passing 'mode' (may be null)
        */
        public void setNextBootMode(String mode)
        {
            final long ident = Binder.clearCallingIdentity();
            try {
                setInternalNextBootMode(mode);
            } finally {
                Binder.restoreCallingIdentity(ident);
            }
        }
